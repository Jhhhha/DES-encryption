...
#define DESTABLE_H
// 初始置换表 (IP)
const static int initIPTable[64] = {
...
// 初始逆置换表 (IP-1)
const static int inverseIPTable[64] = {
...
//移位函数表
const static int shiftTable[16] =
{
    1, 1, 2, 2, 2, 2, 2, 2,
    1, 2, 2, 2, 2, 2, 2, 1
};
